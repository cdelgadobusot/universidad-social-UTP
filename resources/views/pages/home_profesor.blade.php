...
<div class="container" style="max-width:1100px">
  <h1 style="margin-bottom:1rem">Panel del Profesor</h1>
  @if (session('status'))
        ...
        <tbody>
          @forelse($pendientes as $p)
            ...
            <tr>
              ...
              <td>{{ $p->work_type }}</td>
              <td>
                <button class="btn btn-secondary" onclick="openDesc('desc-prof-pend-{{ $p->id }}')">Ver descripción</button>
                <template id="desc-prof-pend-{{ $p->id }}">
        ...
        <tbody>
          @forelse($activas as $p)
            ...
            <tr>
              ...
              <td>{{ $p->work_type }}</td>
              <td>
                <button class="btn btn-secondary" onclick="openDesc('desc-prof-act-{{ $p->id }}')">Ver descripción</button>
                <template id="desc-prof-act-{{ $p->id }}">
                  <h3 style="margin-top:0">Descripción de la propuesta</h3>
                  <p style="white-space:pre-wrap">{{ $p->description ?? '—' }}</p>
                </template>
              </td>
        ...
        <tbody>
          @forelse($finales as $p)
            ...
            <tr>
              ...
              <td>{{ $p->work_type }}</td>
              <td>
                <button class="btn btn-secondary" onclick="openDesc('desc-prof-fin-{{ $p->id }}')">Ver descripción</button>
                <template id="desc-prof-fin-{{ $p->id }}">
                  <h3 style="margin-top:0">Descripción de la propuesta</h3>
                  <p style="white-space:pre-wrap">{{ $p->description ?? '—' }}</p>
                </template>
              </td>
